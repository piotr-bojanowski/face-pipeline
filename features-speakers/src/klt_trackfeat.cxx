...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	float	x1 = (float) mxGetScalar(prhs[2]);
	float	y1 = (float) mxGetScalar(prhs[3]);
	float	x2 = (float) mxGetScalar(prhs[4]);
	float	y2 = (float) mxGetScalar(prhs[5]);
	...
	plhs[1] = mxCreateDoubleScalar(x2);
	plhs[2] = mxCreateDoubleScalar(y2);
}
